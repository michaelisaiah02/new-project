      ...
      <div class="row justify-content-md-center g-2 column-gap-4">
        <div class="col-md-5">
          <div class="input-group">
            ...
            <select class="form-select bg-warning-subtle border-warning border" placeholder="Username" aria-label="Username"
              aria-describedby="customer" id="customer" name="customer_code">
        ...
        <div class="col-md-6">
          <div class="input-group">
            <span class="input-group-text border-dark border-3 bg-secondary-subtle adjust-width">Department</span>
            <input type="text" class="form-control bg-secondary-subtle border-secondary border" id="department"
              placeholder="Nama Department" aria-label="Department" aria-describedby="department" readonly>
          </div>
        </div>
        <div class="col-md-5">
          <div class="input-group">
            <span class="input-group-text border-dark border-3 bg-secondary-subtle adjust-width">Model</span>
            <input type="text" class="form-control bg-warning-subtle border-warning border" placeholder="Model Part"
              aria-label="Model Part" aria-describedby="model" id="model" name="model" value="{{ old('model') }}">
          </div>
        </div>
        <div class="col-md-6">
          <div class="row">
            ...
            <div class="col">
              <button type="button" class="btn btn-primary border-3 border-light-subtle w-100" id="btn-upload-2d"
                disabled>Upload 2D</button>
              <input type="file" class="form-control bg-secondary-subtle border-secondary border" id="upload-2d"
                name="drawing_2d" placeholder="Upload 2D" aria-label="Upload 2D" aria-describedby="upload-2d" hidden
                value="{{ old('drawing_2d') }}">
            </div>
            <div class="col">
              <button type="button" class="btn btn-primary border-3 border-light-subtle w-100" id="btn-upload-3d"
                disabled>Upload 3D</button>
              <input type="file" class="form-control bg-secondary-subtle border-secondary border" id="upload-3d"
                name="drawing_3d" placeholder="Upload 3D" aria-label="Upload 3D" aria-describedby="upload-3d" hidden
                value="{{ old('drawing_3d') }}">
            </div>
          </div>
        </div>
        <div class="col-md-5">
          <div class="input-group">
            <span class="input-group-text border-dark border-3 bg-secondary-subtle adjust-width" id="part-num-label">No.
              Part</span>
            <input type="text" class="form-control bg-warning-subtle border-warning border" placeholder="Nomor Part"
              aria-label="Nomor Part" aria-describedby="part-num-label" id="part-num" name="part_number"
        ...
        <div class="col-md-6">
          <div class="input-group">
            <input type="text" class="form-control bg-secondary-subtle border-secondary border"
              placeholder="Nama File Drawing 2D" aria-label="Nama File Drawing 2D" aria-describedby="drawing-label-2d"
              id="drawing-label-2d" name="drawing_label_2d" readonly value="{{ old('drawing_label_2d') }}">
            <input type="text" class="form-control bg-secondary-subtle border-secondary border"
              placeholder="Nama File Drawing 3D" aria-label="Nama File Drawing 3D" aria-describedby="drawing-label-3d"
              id="drawing-label-3d" name="drawing_label_3d" readonly value="{{ old('drawing_label_3d') }}">
          </div>
        </div>
        <div class="col-md-5">
          <div class="input-group">
        ...
        <div class="col-md-6">
          <div class="input-group">
            <span class="input-group-text border-dark border-3 bg-secondary-subtle fs-7">No.
              ECI/EO/ECN</span>
            <input class="form-control bg-warning-subtle border-warning border" placeholder="Nomor Revisi Drawing"
              aria-label="Nomor Revisi Drawing" aria-describedby="eee-number" id="eee-number" name="eee_number"
              value="{{ old('eee_number') }}">
            <span class="input-group-text border-dark border-3 bg-secondary-subtle fs-7">No.
              Drawing</span>
            <input class="form-control bg-warning-subtle border-warning border" placeholder="Nomor Revisi Drawing"
              aria-label="Nomor Revisi Drawing" aria-describedby="drawing-number" id="drawing-number"
        ...
        <div class="col-md-5">
          <div class="input-group">
            ...
            <select class="form-select bg-warning-subtle border-warning border"
              placeholder="Hose/Molding/Weatherstrip/Bonding Metal" aria-label="Hose/Molding/Weatherstrip/Bonding Metal"
              aria-describedby="part-type" id="part-type" name="part_type">
              ...
              <option value="Weatherstrip" {{ old('part_type') == 'Weatherstrip' ? 'selected' : '' }}>Weatherstrip
              </option>
              <option value="Bonding Metal" {{ old('part_type') == 'Bonding Metal' ? 'selected' : '' }}>Bonding Metal
              </option>
            </select>
          </div>
        </div>
        <div class="col-md-6">
          <div class="input-group">
            <span
              ...
              Revision
              Date</span>
            <input class="form-control bg-warning-subtle border-warning border" type="date" aria-label="dd/mm/yyyy"
              aria-describedby="drawing-revision-date" id="drawing-revision-date" name="drawing_revision_date"
        ...
        <div class="col-md-5">
          <div class="input-group">
            ...
            <input class="form-control bg-warning-subtle border-warning border" placeholder="Qty/Year (pcs)"
              aria-label="Qty/Year (pcs)" aria-describedby="qty" id="qty" name="qty" type="number"
              value="{{ old('qty') }}">
          </div>
        </div>
        <div class="col-md-6">
          <div class="input-group">
            <span
              ...
              GO</span>
            <input class="form-control bg-warning-subtle border-warning border" type="date" aria-label="dd/mm/yyyy"
              aria-describedby="receive-date-sldg" id="receive-date-sldg" name="receive_date_sldg"
              value="{{ old('receive_date_sldg') }}">
            <span class="input-group-text border-dark border-3 bg-secondary-subtle fs-7 text-wrap"
              style="width: 6rem;">No. SdPK
              /LOI/DIE
              GO</span>
            <input class="form-control bg-warning-subtle border-warning border" placeholder="No. SPK /LOI/DIE GO"
              aria-label="No. SPK /LOI/DIE GO" aria-describedby="sldg-number" id="sldg-number" name="sldg_number"
        ...
        <div class="col-md-5">
          <div class="input-group">
            <span class="input-group-text border-dark border-3 bg-secondary-subtle adjust-width">Target
              Masspro</span>
            <input class="form-control bg-warning-subtle border-warning border" placeholder="dd/mm/yyyy" type="date"
              aria-label="dd/mm/yyyy" aria-describedby="masspro-target" id="masspro-target" name="masspro_target"
        ...
        <div class="col-md-6">
          <div class="input-group">
            ...
            <input class="form-control bg-warning-subtle border-warning border" placeholder="Minor Change"
              aria-label="Pesan dari management" aria-describedby="minor-change" id="minor-change" name="minor_change"
              value="{{ old('minor_change') }}">
          </div>
        </div>
        <div class="col-md-5">
          <div class="input-group">
