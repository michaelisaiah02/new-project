        ...
        <div class="modal-dialog">
            <form class="modal-content needs-validation" method="POST" id="userForm" novalidate>
                ...
                <div class="modal-body">
                    <div class="row">
                        <label for="id" class="form-label mb-0 mt-1">ID User</label>
                    ...
                    <div class="row">
                        <label for="name" class="form-label mb-0 mt-1">User Name</label>
                    ...
                    <div class="row">
                        <label for="whatsapp" class="form-label mb-0 mt-1">WhatsApp Number</label>
                    ...
                    <div class="row">
                        <label for="email" class="form-label mb-0 mt-1">Email</label>
