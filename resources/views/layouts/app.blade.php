...
<body>
  <nav
    class="navbar navbar-expand-lg navbar-light text-light py-0 my-0 {{ request()->is('login') ? 'bg-transparent px-3' : 'bg-primary' }}"
    id="navbar-project">
    <div class="container-fluid justify-content-between my-0 py-0">
      ...
      <div
        class="row text-center justify-content-end align-items-center w-75 {{ request()->is('login') ? 'text-light' : 'bg-none' }}"
        id="title-section">
        ...
        @if (!request()->is('login'))
          <div class="col-md-auto">
            <div class="card my-0 py-0">
              <div class="card-body my-0 py-0 bg-secondary-subtle border-3 border-light-subtle rounded-3 text-center">
